...
from data_aug.contrastive_learning_dataset import Test_dataset
...
parser.add_argument('--seed', default=None, type=int,
                    help='seed for disableinitializing training. ')
...
def main():
    ...
    if not args.disable_cuda and torch.cuda.is_available():
        ...
        args.gpu_index = -1
    print('>>>>>>>>>>> device info : ', args.device)
    dataset = ContrastiveLearningDataset(channel=args.channel)
    train_dataset = dataset.get_dataset(phase='train', n_views=args.n_views)
    # test_dataset = Test_dataset(channel=args.channel)
